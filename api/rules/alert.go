...
func createAlertRules(alert *nais_io_v1.Alert) (alertRules []Alert) {
...
func addOrUpdateAlert(alert *nais_io_v1.Alert, configMap *corev1.ConfigMap) (*corev1.ConfigMap, error) {
